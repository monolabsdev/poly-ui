    ...
    >
      <div
        ...
        className={cn(
          ...
          variant === "floating" && "rounded-2xl shadow-sm ring-1 ring-sidebar-border",
        )}
      >
        {children}
      </div>
